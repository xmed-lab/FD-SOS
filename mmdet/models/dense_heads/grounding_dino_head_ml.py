...
from .dino_head_ml import DINOHeadML
...
class GroundingDINOHeadML(DINOHeadML):
    ...
    def _init_layers(self) -> None:
        ...
        if self.share_pred_layer:
            ...
            # TODO make cls_branches two, No FD, FD
            self.cls_branches = nn.ModuleList(
    ...
    def _get_targets_single(self, cls_score: Tensor, bbox_pred: Tensor,
        ...
        # TODO marwan no care
        label_weights[assign_result.gt_inds < 0] = 0
    ...
    def loss(self, hidden_states: Tensor, references: List[Tensor],
             ...
             enc_outputs_class: Tensor, enc_outputs_class_2: Tensor,
    ...
    def loss_by_feat_single(self, cls_scores: Tensor, bbox_preds: Tensor,
        ...
        if isinstance(self.loss_cls, QualityFocalLoss):
            ...
            # TODO marwan check here to modify loss
