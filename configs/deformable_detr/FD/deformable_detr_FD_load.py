_base_ = 'deformable_swin-t_finetune_16xb2_1x_coco.py'

load_from = '/home/mkfmelbatel/mmdetection/tooth_robo_wdb_anterior_deform/best_coco_bbox_mAP_epoch_18.pth'  # noqa
data_root = 'data/v1/'
...
vis_backends = [
    dict(type='WandbVisBackend',
         init_kwargs={
             ...
             'group': 'deformable_detr_OOD_baseline'
         })
]
visualizer = dict(
