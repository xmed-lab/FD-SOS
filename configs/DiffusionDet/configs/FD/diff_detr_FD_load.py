_base_ = 'diffusiondet_swin_fpn_500.py'


load_from = '/home/mkfmelbatel/mmdetection/tooth_robo_wdb_anterior_diff/best_coco_bbox_mAP_epoch_20.pth'  # noqa
data_root = 'data/v1/'
...
model = dict(bbox_head=dict(num_classes=num_classes,
             criterion=dict(num_classes=num_classes)))
